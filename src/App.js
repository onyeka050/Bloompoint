...
import aweMfb from "./awe-logo.jpeg";
import "./App.scss";
    ...
    <>
      ...
      <header>
        <div className="info">
          ...
          <img
            src="https://developer.interswitchgroup.com/static/media/Flutterwave_Logo.346a43ef.svg"
            alt="logo"
            className="logo"
          />
          <img
            src="https://merchant.korapay.com/static/media/logo-kpy-ent.b2729ade.svg"
            alt="logo"
            className="logo"
          />
          ...
          <img
            src={aweMfb}
            alt="Awe Microfinance Bank Logo"
            className="logo2"
          />
        </div>
        <img
      ...
      <section className="pricing_section">
        ...
        <div className="pricing_flex">
          ...
          <div className="price_card valued">
            ...
            <p className="special" onClick={() => setModalVisible(true)}>
              POPULAR
            </p>
          </div>
          <div className="price_card">
      ...
      <footer>
        ...
        <div className="footer_info">
          <div>
            <h3>ADDRESS</h3>
            <p>1, Adedeji Adekola Street,</p>
            <p>Off Freedom Way, Lekki Phase 1</p>
            <p>Lekki, Lagos.</p>
